...
if __name__ == "__main__":
    ...
    parser.add_argument('--iphoneos_archs', default=None, help='select iPhoneOS target ARCHS')
    parser.add_argument('--iphonesimulator_archs', default=None, help='select iPhoneSimulator target ARCHS')
    ...
    if args.iphonesimulator_archs and not os.environ.get('BUILD_PRECOMMIT', None):
    ...
    b = iOSBuilder(args.opencv, args.contrib, args.dynamic, args.bitcodedisabled, args.without, args.disable, args.enablenonfree, targets, args.debug, args.debug_info)
    b.build(args.out)
